...
(function rideScopeWrapper($) {
    ...
    function completeRequest(result) {
        ...
        html = '<p>Response received from API ' + result_id + '.......please check the immediate recommedations. you will get the additional recommendations for 3 days to your mail , when some-one answered your query'+ '</p>';
